...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stub_functions_passbyvariablereferencenested, 0, 1, IS_VOID, 0)

	ZEND_ARG_INFO(1, i)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stub_functions_passbyvariabledefaultreference, 0, 0, IS_VOID, 0)

	ZEND_ARG_INFO(1, i)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stub_functions_passbyvariablearrayreference, 0, 1, IS_VOID, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_stub_functions_postinc, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(stub_functions_method_entry) {
	...
	PHP_ME(Stub_Functions, passByVariableReferenceNested, arginfo_stub_functions_passbyvariablereferencenested, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_Functions, passByVariableDefaultReference, arginfo_stub_functions_passbyvariabledefaultreference, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_Functions, passByVariableArrayReference, arginfo_stub_functions_passbyvariablearrayreference, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Stub_Functions, postInc, arginfo_stub_functions_postinc, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
