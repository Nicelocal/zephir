	...
	if ((zephir_file_exists(&_1) == SUCCESS)) {
		...
		do {
			if (ZEPHIR_IS_LONG(&_9$$4, 1)) {
				...
				ZEPHIR_CALL_FUNCTION(&_11$$6, "imagecreatefromgif", NULL, 70, &_10$$6);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_9$$4, 2)) {
				...
				ZEPHIR_CALL_FUNCTION(&_13$$7, "imagecreatefromjpeg", NULL, 71, &_12$$7);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_9$$4, 3)) {
				...
				ZEPHIR_CALL_FUNCTION(&_15$$8, "imagecreatefrompng", NULL, 72, &_14$$8);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_9$$4, 15)) {
				...
				ZEPHIR_CALL_FUNCTION(&_17$$9, "imagecreatefromwbmp", NULL, 73, &_16$$9);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_9$$4, 16)) {
				...
				ZEPHIR_CALL_FUNCTION(&_19$$10, "imagecreatefromxbm", NULL, 74, &_18$$10);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_29, 75, &_28$$4, &__$true);
		zephir_check_call_status();
	} else {
		_30$$13 = !width;
		if (!(_30$$13)) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$13, "imagecreatetruecolor", NULL, 76, &_35$$13, &_36$$13);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_29, 75, &_36$$13, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Stub_Oo_OoDestruct, __destruct)
{
	...
	if (Z_TYPE_P(&image) == IS_RESOURCE) {
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 78, &image);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Oo_OoDestruct, getVersion)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "defined", NULL, 79, &_3);
	zephir_check_call_status();
	if (zephir_is_true(&_4)) {
		ZEPHIR_INIT_NVAR(&version);
		ZEPHIR_GET_CONSTANT(&version, "GD_VERSION");
	} else {
		ZEPHIR_CALL_FUNCTION(&info, "gd_info", NULL, 80);
		zephir_check_call_status();
